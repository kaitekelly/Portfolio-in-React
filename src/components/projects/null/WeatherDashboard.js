...
import WeatherPic from "../../assets/weather-dashboard.jpg";
...
const WeatherApp = (props) => {
  return (
    <div>
      <Card>
        <CardImg top width="100%" src={WeatherPic} alt="Weather Dashboard Screenshot" />
        <CardBody>
          <CardTitle>Weather Dashboard App</CardTitle>
